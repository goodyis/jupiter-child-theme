...
// needed here and in parent theme --> @goodyis
...
/* define child theme framework --> @goodyis */
        define("C_THEME_FRAMEWORK", CHILD_THEME_DIR . "/framework");
/* move base framework definition here to access earlier */
        define("THEME_FRAMEWORK", THEME_DIR . "/framework");
        //Added and important unless you want to copy/edit ALL helpers --> @goodyis 
        define("PARENT_THEME_HELPERS",THEME_FRAMEWORK . "/helpers");

/* define child theme components/features --> @goodyis */
        //define("THEME_COMPONENTS", CHILD_THEME_DIR_URI . "/components");
        //define("THEME_HELPERS", C_THEME_FRAMEWORK . "/helpers");
        //define("THEME_FUNCTIONS", C_THEME_FRAMEWORK . "/functions");
        //define("THEME_PLUGIN_INTEGRATIONS", C_THEME_FRAMEWORK . "/plugin-integrations");
        //define('THEME_POST_TYPES', C_THEME_FRAMEWORK . '/custom-post-types');
/* END CUSTOMIZATION */
        ...
        // now called earlier --> @goodyis
        //define("THEME_FRAMEWORK", THEME_DIR . "/framework");
        // could be called from child --> @goodyis
    ...
    /* END function contraints */

    public function backward_compatibility()
    { 
        require_once PARENT_THEME_HELPERS . "/php-backward-compatibility.php"; 
    }
    ...
    {
/* would be nice to mention the 'use' in documentation, or setting in theme options --> @goodyis */
        // personally don't use --> @goodyis
...
/* would be nice for these not to autopopulate, could be setting in theme options --> @goodyis */
        register_nav_menus(array(
            ...
            'calc_menu' => __('Calculator Navigation', "mk_framework"),
        ));

    }
    /* would be nice for documentation on importance/conflicts with
    mK_custom posts and other 3rd party custom post additions, 
    if for nothing else a reference to server source waste --> @goodyis */
    ...
    public function functions()
    {
        ...
        // your templates DO NOT play nicely with YITH, just fyi --> @goodyis
        ...
        /* be nice to have documentation that the ajax call, actually calls a 'new' instance of the loop
        and has a default style loop attached to it, had to pass 'my' current loop style to the ajax request -->@goodyis */
    ...
    {
        /* remove parent_ if you want the child-theme 'version' --> @goodyis */
        require_once PARENT_THEME_HELPERS . "/class-mk-fs.php";
        require_once PARENT_THEME_HELPERS . "/class-logger.php";
        require_once PARENT_THEME_HELPERS . "/survey-management.php";
        require_once PARENT_THEME_HELPERS . "/db-management.php";
        require_once PARENT_THEME_HELPERS . "/logic-helpers.php";
        require_once PARENT_THEME_HELPERS . "/svg-icons.php";
        require_once PARENT_THEME_HELPERS . "/image-resize.php";
        require_once PARENT_THEME_HELPERS . "/template-part-helpers.php";
        require_once PARENT_THEME_HELPERS . "/global.php";
        require_once PARENT_THEME_HELPERS . "/wp_head.php";
        require_once PARENT_THEME_HELPERS . "/wp_footer.php";
        require_once PARENT_THEME_HELPERS . "/schema-markup.php";
        require_once PARENT_THEME_HELPERS . "/wp_query.php";
        require_once PARENT_THEME_HELPERS . "/send-email.php";
        require_once PARENT_THEME_HELPERS . "/captcha.php";
    }
    ...
    public function admin()
    {
        ...
        if (is_admin() || (empty($abb_phpunit) == false && $abb_phpunit == true))
        {
            ...
            require_once THEME_CONTROL_PANEL . "/logic/compatibility.php";
                //moved from below template-management.php in 5.9
